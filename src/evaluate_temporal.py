...
if __name__ == "__main__":
    ...
    result_filename = f'{set_name}set_result_model{data_model}_2_{model_name[-4::]}_temporal.h5'
    evaluation_filename = f'plots/eval_rel_err_{data_model}_2_{model_name[-4::]}_temporal.h5'
    ...
    with h5py.File(res_filepath, mode = 'r' ) as h_pred:
        with h5py.File(gt_filepath, mode = 'r' ) as h_gt:
            with h5py.File(lr_filepath, mode = 'r' ) as h_lr:
                ...
                show_temporal_development_line(gt["u"], lr["u"], pred["u"],gt["mask"], axis=3, indices=(20,20), save_as=f'{eval_dir}/test_temporal_development.png')
                plt.clf()
                ...
                show_timeframes(gt["u"], lr["u"], pred["u"],gt["mask"], timepoints=[4, 5, 6, 7, 8], axis=0, idx = 22, save_as=f'{eval_dir}/time_frame_examples.png')
    ...
    plot_regression(gt, pred, frame_idx= 10, save_as=f'{result_dir}/plots/Plot_regression')
    plt.clf()
