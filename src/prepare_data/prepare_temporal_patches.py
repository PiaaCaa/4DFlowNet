...
if __name__ == "__main__": 
    ...
    base_path = '4DFlowNet/data/CARDIAC'
    lr_file = 'M1_1mm_step5_static_TLR.h5' #LowRes velocity data
    hr_file = 'M1_1mm_step5_static.h5' #HiRes velocity data
    output_filename = f'{base_path}/test{patch_size}{"MODEL1_1"}.csv'
