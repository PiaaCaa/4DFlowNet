        ...
        for c in cases:
            ...
            if not super_resolved_prediction:
                if plt_corrplot: 
                    ...
                    plot_k_r2_vals(data_original, data_predicted, bounds, peak_flow_frame,color_b = KI_colors['Plum'] , save_as= f'{eval_dir}/K_r2_frame{frame_corr_plot}_{name_evaluation}')
