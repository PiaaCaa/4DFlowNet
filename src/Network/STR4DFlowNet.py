...
#TODO change that is works for other dimensions too, OR, always transpose such that we have the same input shape
#TODO important! if first transpose and then predict -> it need to be permuted back AND check that the correct slices are compared at the end!!!!
