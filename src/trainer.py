...
if __name__ == "__main__":
    ...
    # ---- Patch index files ----
    training_file = '{}/train16MODEL1_2.csv'.format(data_dir) 
    validate_file = '{}/validate16MODEL3_2.csv'.format(data_dir)

    QUICKSAVE = True
    benchmark_file = '{}/benchmark16MODEL1_1.csv'.format(data_dir)
