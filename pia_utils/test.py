...
if __name__ == '__main__':
    ...
    csv_files = [ 'Temporal16MODEL2_2mm_step2_cs_invivomagn_exclfirst2frames.csv', 'Temporal16MODEL3_2mm_step2_cs_invivomagn_exclfirst2frames.csv', 
                  'Temporal16MODEL5_2mm_step2_cs_invivomagn_exclfirst2frames.csv', 'Temporal16MODEL6_2mm_step2_cs_invivomagn_exclfirst2frames.csv']
    csv_files = [f'{csv_dir}/{f}' for f in csv_files]
    new_file = f'{csv_dir}/Temporal16MODEL2356_2mm_step2_cs_invivomagn_exclfirst2frames.csv'
